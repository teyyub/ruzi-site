...
// });
const logoUrl = computed(() => {
  return 'layout/images/logo-new.jpeg';
});
</script>
...
<!--                    <Button label="Get Started" class="p-button-rounded text-xl border-none mt-5 bg-blue-500 font-normal text-white line-height-3 px-3"></Button>-->
              ...
              <div class="flex justify-content-center md:justify-content-end">
                <img src="/demo/images/landing/screen-3.jpeg" alt="Hero Image" class="w-9 md:w-auto" />
              </div>
            </div>
                    ...
                    <div class="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-900">Rəşad İbrahimov
                                  SEO</h5>
                    ...
                    <div class="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-900">Şükür Musayev
                                  Marketinq direktor</h5>
                    ...
                    <div class="col-12 md:col-12 lg:col-4 p-0 lg:pb-5 mt-4 lg:mt-0">
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-900">Anar Vaqifoğlu
                                  Maliyyə departamenti direktoru</h5>
                    ...
                    <div class="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-900">Sirac Çingiz
                                  Regional satış departamenti direktoru</h5>
            ...
            <div id="highlights" class="py-4 px-4 lg:px-8 mx-0 my-6 lg:mx-8">
                ...
                <div class="grid mt-8 pb-2 md:pb-8">
                    <div class="flex justify-content-center col-12 lg:col-6 bg-purple-100 p-0 flex-order-1 lg:flex-order-0" style="border-radius: 8px">
                        <img src="/demo/images/landing/img1.jpeg" class="w-11" alt="mockup mobile" />
                    </div>
                ...
                <div class="grid my-8 pt-2 md:pt-8">
                    ...
                    <div class="flex justify-content-end flex-order-1 sm:flex-order-2 col-12 lg:col-6 bg-yellow-100 p-0" style="border-radius: 8px">
                        <img src="/demo/images/landing/img2.jpeg" class="w-11" alt="mockup" />
                    </div>
                </div>
              <div class="grid mt-8 pb-2 md:pb-8">
                <div class="flex justify-content-center col-12 lg:col-6 bg-purple-100 p-0 flex-order-1 lg:flex-order-0" style="border-radius: 8px">
                  <img src="/demo/images/landing/img3.jpeg" class="w-11" alt="mockup mobile" />
                </div>
              ...
              <div class="grid my-8 pt-2 md:pt-8">
                ...
                <div class="flex justify-content-end flex-order-1 sm:flex-order-2 col-12 lg:col-6 bg-yellow-100 p-0" style="border-radius: 8px">
                  <img src="/demo/images/landing/img4.jpeg" class="w-11" alt="mockup" />
                </div>
              </div>
            </div>
